...
export const ChatWindow = (props) => {
    ...
    return (
<>
        <div className=' absolute w-full bg-blue-200 p-36  -ml-2 rounded-md  opacity-75 '>0</div>
        <div className=' absolute inset-x-1/2 mt-3 z-20 flex flex-col items-center  '>
